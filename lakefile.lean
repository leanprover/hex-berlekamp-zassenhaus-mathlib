...
require HexBerlekampZassenhaus from git
  "https://github.com/leanprover/hex-berlekamp-zassenhaus.git" @ "v0.4.0"

require HexBerlekampMathlib from git
  "https://github.com/leanprover/hex-berlekamp-mathlib.git" @ "v0.4.0"

require HexHenselMathlib from git
  "https://github.com/leanprover/hex-hensel-mathlib.git" @ "v0.4.0"

require HexPolyZMathlib from git
  "https://github.com/leanprover/hex-poly-z-mathlib.git" @ "v0.4.0"

require HexMatrixMathlib from git
  "https://github.com/leanprover/hex-matrix-mathlib.git" @ "v0.4.0"

require HexLLLMathlib from git
  "https://github.com/leanprover/hex-lll-mathlib.git" @ "v0.4.0"
...
require HexRowReduce from git
  "https://github.com/leanprover/hex-row-reduce.git" @ "v0.4.0"
...
require HexPolyFp from git
  "https://github.com/leanprover/hex-poly-fp.git" @ "v0.4.0"
...
require HexPolyMathlib from git
  "https://github.com/leanprover/hex-poly-mathlib.git" @ "v0.4.0"

require HexRowReduceMathlib from git
  "https://github.com/leanprover/hex-row-reduce-mathlib.git" @ "v0.4.0"

require HexModArithMathlib from git
  "https://github.com/leanprover/hex-mod-arith-mathlib.git" @ "v0.4.0"

require HexGramSchmidtMathlib from git
  "https://github.com/leanprover/hex-gram-schmidt-mathlib.git" @ "v0.4.0"
